      ...
      <div class="accordion-item">
        <div class="row d-flex">
          ...
          <div class="col-1 d-flex align-items-center">
            <a onclick=" return confirm('Bạn có chắc chắn muốn xóa không')" href="/Nhom13_BookingVePhim_HPHCinemas/Controller/Admin/Donhang/deleteonweb.php?id_donhang=<?php echo $donhang['id_donhang'] ?>" class="btn btn-danger">Xóa</a>
          </div>
