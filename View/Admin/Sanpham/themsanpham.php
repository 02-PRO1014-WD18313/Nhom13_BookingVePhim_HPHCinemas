<div class="main-content">
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                <li>
                    ...
                    <a href="/Nhom13_BookingVePhim_HPHCinemas/Controller/Admin/index.php?action=danhmuc">Trang Phim</a>
                </li>
            </ul><!-- /.breadcrumb -->
        </div>
        ...
        <div class="container">
            ...
            ?>
            <form action="/Nhom13_BookingVePhim_HPHCinemas/Controller/Admin/SanPham/add.php" method="post" onsubmit="return validateForm()" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <a class=" chuyentrang" href="/Nhom13_BookingVePhim_HPHCinemas/Controller/Admin/index.php?action=danhsachphim&page=1&maxPageItem=5&sortName=id_phim&sortBy=desc">Xem danh sách sản phẩm</a>
                </div>
            </div>
