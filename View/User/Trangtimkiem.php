    ...
    <div class="container px-4 px-lg-5 mt-5">
        ...
        <form action="" method="get">
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3  justify-content-center">
                ...
                foreach ($arrayPhim as $phims) {
                    $listPhim = FindPhim($phims);
                    $length = sizeof($listPhim);
                    foreach(FindPhim($phims) AS $phim){
                ?>
                    <div class="col-4 mb-5" style="margin-top: 15px;">
                        <div class="card h-100" style="width: 80%;">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class=" form-control btn btn-outline-dark mt-auto" href="#">Mua vé</a></div>
                            </div>
                        </div>
                    </div>
                <?php
